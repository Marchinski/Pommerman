...
import players.mctsTransAlpha.MCTSParamsALPHA;
import players.mctsTransAlpha.MCTSPlayerALPHA;
...
public class Test_RAVEMCTS {
    ...
    public static void main(String[] args) {
        ...
        //default
        if(args.length == 0)
            args = new String[]{"0", "-1", "10", "-1", "5", "3", "3", "3"};
            ...
            for(int i = 4; i <= 7; ++i) {
                ...
                switch(agentType) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        MCTSParamsTransposition mctsParamst = new MCTSParamsTransposition();
                        mctsParamst.stop_type = mctsParamst.STOP_ITERATIONS;
                        mctsParamst.num_iterations = 200;
                        mctsParamst.rollout_depth = 12;

                        mctsParamst.heuristic_method = mctsParamst.CUSTOM_HEURISTIC;
                        p = new MCTSPlayerTransposition(seed, playerID++, mctsParamst);
                        playerStr[i-4] = "MCTSTran";
                        break;
                    case 7:
                        MCTSParamsRAVE mctsParamsRave = new MCTSParamsRAVE();
                        mctsParamsRave.stop_type = mctsParamsRave.STOP_ITERATIONS;
                        mctsParamsRave.num_iterations = 200;
                        mctsParamsRave.rollout_depth = 12;

                        mctsParamsRave.heuristic_method = mctsParamsRave.CUSTOM_HEURISTIC;
                        p = new MCTSPlayerRAVE(seed, playerID++, mctsParamsRave);
                        playerStr[i-4] = "MCTSRAVE";
                        break;
                    case 8:
                        MCTSParamsALPHA mctsParamsAlpha = new MCTSParamsALPHA();
                        mctsParamsAlpha.stop_type = mctsParamsAlpha.STOP_ITERATIONS;
                        mctsParamsAlpha.num_iterations = 200;
                        mctsParamsAlpha.rollout_depth = 12;

                        mctsParamsAlpha.heuristic_method = mctsParamsAlpha.CUSTOM_HEURISTIC;
                        p = new MCTSPlayerALPHA(seed, playerID++, mctsParamsAlpha);
                        playerStr[i-4] = "MCTSALPHA";
                        break;
                    default:
